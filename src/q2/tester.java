...
public class tester {
    public static void main(String[] args) {
        ...
        System.out.println("Description at (3, 3): " + matrix.get(3, 3));
        System.out.println("Description at (0, 3): " + matrix.get(0, 3));
        System.out.println("Description at (3, 0): " + matrix.get(3, 0));
        System.out.println("Description at (4, 4): " + matrix.get(4, 4));
